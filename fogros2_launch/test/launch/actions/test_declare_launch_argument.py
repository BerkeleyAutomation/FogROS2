...
def test_declare_launch_argument_constructors():
    ...
    DeclareLaunchArgument("name", default_value="val1", description="description", choices=["val1", "val2"])
...
def test_declare_launch_argument_methods():
    ...
    with pytest.raises(RuntimeError) as excinfo:
        DeclareLaunchArgument("name", description="description", choices=["var1", "var2"], default_value="invalid")
