...
class SSHVerb(VerbExtension):
    ...
    def add_arguments(self, parser, cli_name):
        parser.add_argument(
            ...
            help="Select FogROS instance name to connect")

        parser.add_argument(
            '--user', '-u', type=str, nargs='?', default="ubuntu",
    ...
    def main(self, *, args):
        ...
        print(ssh_cmd)
        proc = subprocess.Popen(ssh_cmd, shell=True, stdin=subprocess.PIPE,
                         stdout=output_buffer, stderr=output_buffer, universal_newlines=True)
